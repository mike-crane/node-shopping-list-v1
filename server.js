...
// we import the ShoppingList and Recipe models, which we'll
...
// adding some items to Recipes so there's some 
Recipes.create('smoothie', ['strawberries', 'milk', 'ice']);
Recipes.create('scrambled eggs', ['eggs', 'cheese', 'butter']);
